    ...
    return (
      <div className="grid-container">
        <div className="grid-item">
          <h1>
            <svg aria-label="vivaestudio" className="logo" enableBackground="new 0 0 310.1 298.36" height="298.36" viewBox="0 0 310.1 298.36" width="310.1" xmlns="http://www.w3.org/2000/svg">
